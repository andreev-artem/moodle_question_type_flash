...
//        Grade: Number - оценка за текущую попытку (вещественное число от 0 до 1)
//        Description: String - текстовое описание оценки. Это описание используется для textual description of grade. This description is going to use
...
//        FlashData: Object   - состояние флеш-ролика в данной попытке, сохраняемое в базе данных.
...
//        OptionalFile: String - ссылка на файл (URL), который был выбран в процессе создания вопроса в Moodle.
//        OptionalData: String - любая текстовая информация указанная в процессе создания вопроса в Moodle.
