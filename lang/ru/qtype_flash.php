...
$string['flash'] = 'Flash-ролик';
$string['flashmovie'] = 'Выберите flash-ролик';
$string['flashwarning'] = 'Имейте в виду, что здесь вы можете выбрать не любой flash-ролик, а только такой, в котором реализована интеграция с системой Moodle!';
$string['editingflash'] = 'Редактирование \"Flash-вопроса\"';
$string['interface'] = 'Интерфейс совместимости';
